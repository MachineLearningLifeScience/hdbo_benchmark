...
def main(
    ...
    run_name = (
        f"rnn-latent_dim-{latent_dim}-batch_size-{batch_size}-lr-{lr}-seed-{seed}"
    )
    run = wandb.init(
...
# python src/hdbo_benchmark/experiments/training_vae_on_zinc250k/train_vae_rnn.py  --latent-dim 2 --seed 0 --batch-size 256 --lr 0.001 --overfit --no-strict-on-hash
# python src/hdbo_benchmark/experiments/training_vae_on_zinc250k/train_vae_rnn.py --latent-dim=2 --lr=0.0005 --batch-size=256 --no-strict-on-hash
